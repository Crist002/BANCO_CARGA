...
void setup(){
  ...
  if(!SD.exists("DATOS.csv")){
      ...
      if (myFile) {
        myFile.println("FECHA,HORA,DIRECCION,FUNCION,TAMAÑO,REGISTRO 1A,REGISTRO 1B,REGISTRO 2A,REGISTRO 2B,REGISTRO 3A,REGISTRO 3B,REGISTRO 4A,REGISTRO 4B,REGISTRO 5A,REGISTRO 5B,REGISTRO 6A,REGISTRO 6B,CRC 1,CRC 2");
        myFile.close();
      } else {
